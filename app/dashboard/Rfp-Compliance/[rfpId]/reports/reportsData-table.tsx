...
export default function ReportsDataTable<TData, TValue>({
  ...
  // mark prefsLoaded true if preferences were provided (this component currently doesn't accept preferences prop,
  // but keep behavior consistent if props are added later)
  ...
  // we already have a sorting value from localStorage, or we have a data array present
  const readyToRender =
  ...
  useEffect(() => {
    const fetchPreferences = async () => {
      try {
        ...
        console.error("Failed loading preferences", error);
        setPrefsLoaded(true);
      }
    };
    fetchPreferences();
